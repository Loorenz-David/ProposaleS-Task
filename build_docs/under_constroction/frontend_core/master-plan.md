...
| 04 | Derived presentation: status and the derivation register | `plans/phase-04-derived-presentation.md` | 5 | `IMPLEMENTED` | 2026-09-07 | Codex | implemented in round 1; 22 measurable rows green, 2 held, 5/5 named mutations red-and-reverted; unit **205/205**, E2E **69/69**, typecheck, lint, build green |
