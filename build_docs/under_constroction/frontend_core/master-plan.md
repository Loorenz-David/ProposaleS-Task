...
| 03 | Session runtime and the tab strip | `plans/phase-03-session-runtime-and-tabs.md` | 7 | `IMPLEMENTED` | 2026-09-07 | Codex | Session runtime, Radix tab strip, creation/reorder/close flows, active-tab reveal and browser evidence implemented; 183 unit tests and 69 end-to-end tests green at closeout. |
