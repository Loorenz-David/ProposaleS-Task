...
| 02 | Persistent shell: landmarks, divider, narrow width, containment | `plans/phase-02-workspace-shell.md` | 6 | `IMPLEMENTED` | 2026-09-07 | Codex | fix round 2: 60/60 rows mapped; 17/17 named mutations executed and reverted (16 reds, C4(g) honestly unmeasurable); unit 154/154, E2E 66/66, typecheck/lint/build green |
