...
| 02 | Persistent shell: landmarks, divider, narrow width, containment | `plans/phase-02-workspace-shell.md` | 6 | `PROMPT_READY` | 2026-09-06 | coordinator | 27 ledger rows, 1 owner card (decision 14, the 780px floor). All 27 routed by the coordinator; 17 folded into the plan, 1 upstream to the intention, 9 granted as written delegations. Rows re-derived 30 → 58, named mutations 5 → 11, product scope unchanged |
