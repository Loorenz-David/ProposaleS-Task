...
| 3 | Proposales adapter: transport, error translation, content read | `plans/phase-03-proposales-transport-and-content.md` | `IMPLEMENTED` | 2026-09-05 | Codex | 55 phase tests pass; 9/9 named mutations reddened and reverted; checkpoint recorded in implementer handoff. |
