...
| **Phases** | 15: phases 1–4 `APPROVED`, phase 5 `IMPLEMENTING` (fix round 2), phases 6–15 `NOT_STARTED` (§4) |
...
| 5 | Proposition schema and structural provenance | `plans/phase-05-proposition-and-provenance.md` | `IMPLEMENTING` | 2026-09-06 | Codex | Fix round 2 dispatched for review S1–S3 and contained notes N2–N5; independent re-review waived by owner after coordinator validation of the completed fix. |
