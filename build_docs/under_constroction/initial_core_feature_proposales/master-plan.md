...
| 7 | Content ranking domain and human search | `plans/phase-07-ranking-and-human-search.md` | `REVIEWING` | 2026-09-06 | Claude | Round 1 implementer: 9 files (8 new, 1 edited), 56/56 rows covered, 14/14 named mutations run and reverted. Closing L4 `npm test`: 24 files / 334 tests green; `npm run typecheck` and `npm run lint` clean. Coordinator fold 2026-09-06: perimeter, counts and evidence budget reconciled against the tree; C8(l) and C5(b) corrected in the criteria table; §9.1 rule 15 added. Dispatched for independent review at `f2399ac`. |
...
Criteria total: **104**; rows: **586**; named mutations: **157** — re-derived 2026-09-06 from the fifteen phase acceptance tables (span-aware: `C2(a–o)` counts fifteen rows, `C8(b1..b20)` twenty). Per-phase summands, in phase order:

- criteria `5 + 7 + 6 + 8 + 8 + 8 + 8 + 6 + 6 + 6 + 8 + 8 + 7 + 8 + 5`
- rows `22 + 52 + 51 + 80 + 61 + 54 + 56 + 26 + 22 + 25 + 28 + 33 + 26 + 32 + 18`
- mutations `11 + 19 + 16 + 35 + 21 + 5 + 14 + 4 + 4 + 5 + 7 + 4 + 4 + 4 + 4`
