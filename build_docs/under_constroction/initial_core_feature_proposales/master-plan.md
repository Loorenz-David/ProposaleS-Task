...
| **Phases** | 15: phases 1–5 `APPROVED`, phase 6 `REVIEWING`, phases 7–15 `NOT_STARTED` (§4) |
...
| 6 | Information items, clarification, workflow state, identity | `plans/phase-06-items-clarification-state.md` | `REVIEWING` | 2026-09-06 | coordinator | Checkpoint `760fa45` implements 8 criteria / 54 rows / 5 mutations; implementation handoff reconciled and independent first review dispatched. |
