...
| 5 | Proposition schema and structural provenance | `plans/phase-05-proposition-and-provenance.md` | `IMPLEMENTED` | 2026-09-06 | Codex | Fix round 2 complete: 61 phase tests, 21 named mutations, and 3 correction probes recorded; closing full suite 15 files / 224 tests green. |
