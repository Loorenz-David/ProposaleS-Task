...
| 8 | AI provider boundary (`@/lib/ai`) | `plans/phase-08-ai-provider-boundary.md` | `IMPLEMENTED` | 2026-09-06 | Codex | 6 criteria / 47 rows / 16 distinct named mutations; 45 new tests; all mutations reddened their named rows and were reverted; implementation checkpoint pending review. Vendor versions and lockfile delta recorded in the phase handoff. |
