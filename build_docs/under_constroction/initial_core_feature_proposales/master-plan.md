...
| 4 | Proposales adapter: create, recovery search, read-back, Applied Pricing | `plans/phase-04-proposales-proposals.md` | `REVIEWING` | 2026-09-05 | coordinator | Fix round 2 checkpoint `d937fe8` handed to delta re-review: 8 criteria / 80 rows / 35 mutations; closing L4 12 files / 163 tests green. |
