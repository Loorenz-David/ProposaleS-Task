...
| **Phases** | 15: phases 1–5 `APPROVED`, phase 6 `PROMPT_READY` (fix round 2), phases 7–15 `NOT_STARTED` (§4) |
...
| 6 | Information items, clarification, workflow state, identity | `plans/phase-06-items-clarification-state.md` | `PROMPT_READY` | 2026-09-06 | coordinator | Fix round 2 dispatched for S1–S2; N1 is corrected in the plan, N2 is routed to phase 10, and N3–N4 may close in the same narrow test/type perimeter. Owner authorized coordinator validation rather than another independent review after the fix. |
