...
Criteria total: **106**; rows: **628**; named mutations: **215** — re-derived 2026-09-07 (after the fold of phase-9 review round 1) from the fifteen phase acceptance tables (span-aware: `C2(a–o)` counts fifteen rows, `C8(b1..b20)` twenty; mutation letter suffixes such as `MUT-08-4a` are retained). Per-phase summands, in phase order:

- criteria `5 + 7 + 6 + 8 + 8 + 8 + 8 + 7 + 7 + 6 + 8 + 8 + 7 + 8 + 5`
- rows `22 + 52 + 51 + 80 + 61 + 54 + 57 + 51 + 38 + 25 + 28 + 33 + 26 + 32 + 18`
- mutations `11 + 19 + 16 + 35 + 21 + 5 + 21 + 22 + 37 + 5 + 7 + 4 + 4 + 4 + 4`
