...
| 4 | Proposales adapter: create, recovery search, read-back, Applied Pricing | `plans/phase-04-proposales-proposals.md` | `REVIEWING` | 2026-09-05 | coordinator | Checkpointed implementation handed to independent review: 8 criteria; 75 rows; 33 mutations; implementer reported one closing L4 stamp. |
