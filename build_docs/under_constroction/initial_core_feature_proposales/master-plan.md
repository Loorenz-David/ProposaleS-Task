...
| 5 | Proposition schema and structural provenance | `plans/phase-05-proposition-and-provenance.md` | `IMPLEMENTED` | 2026-09-06 | Codex | 8 criteria / 61 rows / 21 mutations; 15 phase files / 224 full-suite tests green. Checkpoint and implementer handoff recorded. |
