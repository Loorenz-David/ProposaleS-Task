...
| 5 | Proposition schema and structural provenance | `plans/phase-05-proposition-and-provenance.md` | `PROMPT_READY` | 2026-09-05 | coordinator | Projection round 0 consumed: owner confirmed per-field recipient provenance; 8 criteria / 61 rows / 21 mutations after all D1–D22 routes. Implementation prompt queued. |
