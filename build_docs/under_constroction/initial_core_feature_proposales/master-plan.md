...
| 4 | Proposales adapter: create, recovery search, read-back, Applied Pricing | `plans/phase-04-proposales-proposals.md` | `IMPLEMENTED` | 2026-09-05 | Codex | Fix round 2 implemented: 8 criteria / 80 rows / 35 mutations; 12 files / 163 tests green at closing stamp. |
