...
| 4 | Proposales adapter: create, recovery search, read-back, Applied Pricing | `plans/phase-04-proposales-proposals.md` | `IMPLEMENTED` | 2026-09-05 | Codex | 8 criteria; 75 rows; 33 mutations; targeted 67 tests green; helper 22 tests green under temporary L1 config. |
