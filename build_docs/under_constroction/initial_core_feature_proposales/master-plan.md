...
| 5 | Proposition schema and structural provenance | `plans/phase-05-proposition-and-provenance.md` | `NOT_STARTED` | 2026-09-05 | coordinator | 8 criteria / 61 rows / 19 mutations after Phase-4 N6 fold; mandatory projection round 0 queued. |
...
Criteria total: 103; rows: 542; named mutations: 137 — derived from the phase acceptance tables on 2026-09-05 after the Phase-4 approval fold: 5 + 7 + 6 + 8 + 8 + 8 + 7 + 6 + 6 + 6 + 8 + 8 + 7 + 8 + 5 criteria; 22 + 52 + 44 + 80 + 61 + 45 + 28 + 26 + 22 + 25 + 28 + 33 + 26 + 32 + 18 rows; 11 + 19 + 9 + 35 + 19 + 5 + 3 + 4 + 4 + 5 + 7 + 4 + 4 + 4 + 4 mutations. A criterion is a distinct `C<n>` in a phase table; each table line is one row unless its ID explicitly spans letters. Re-derive after any plan amendment; never edit these numbers by hand.
